...
const testData = [
  {
    input: "2017-05-10",
    locale: undefined,
    output: "2017-05-09T23:00:00.000Z"
  },
  {
    input: "2017-05-10",
    locale: { name: "fr" },
  ...
  },
  {
    input: "2017-05-08",
    locale: { name: "uk" },
    output: "2017-05-07T23:00:00.000Z"
  },
  {
    input: "2017-05-11",
    locale: { name: "br" },
    output: "2017-05-10T23:00:00.000Z"
  }
];
  ...
  testData.forEach(item => {
    it(`should return ${item.output} when given ${item.input} and locale is ${JSON.stringify(item.locale)}`, () => {
      const locale = item.locale
        ...
        : "en";
      const result = DateFns.initMoment(moment(item.input), item.locale);
